_base_ = ['../scannet200/AutoSeg3D_sv_scannet200_A3_fpn_2dca_autoloss.py']

# Diagnostic config: run SV A3 model on MV inputs (subset50) and export GT-aligned
# embedding stability diagnostics (oracle by GT IoU).
